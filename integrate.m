...
% Corresponds to eq. 11 of the publication.
% y = sensory feedback 
% dt = discretization step
% delay  = duration of the delay
% u = motor commands
% A, B = System dynamics
% pErr1 = proportional error in the delay parameter - integration of the
%   state
% pErr2 = proportional error in the delay parameter - integration of the
%   motor commands
...
% Uncomment to add noise to the delay estimation.
...
if length(u) < delay_d+1
    % Deal with cases where we don't have enough motor commands (beginning of the movement)
